...
! --------------------------------------------------------------
implicit none
integer(kind=4) jpr,jpnoma,iversion
parameter(jpr=10000) ! taille majorant celle du plus grand article a lire dans le fichier LFA.
...
clfic='testCO.LFA' ! nom du fichier d'entree.
...
! ilong: taille de l'article (nombre minimal d'elements du tableau le recevant).
!
write(*,fmt=*) 'Lecture de l''article ',iart+1
...
enddo
write(*,fmt=*) '	nom: "',trim(clna),'" type: ',itype,' longueur: ',ilong
!
! -------------------------------------------------
